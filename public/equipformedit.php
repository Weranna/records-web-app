<?php
require_once '../includes/models/equipformeditmodel.inc.php';
...
<section class="wrapper-form">
    ...
    <form class="mainForm" action="../includes/editequiph.inc.php" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <input type="text" id="serialNumber" name="serNumber" placeholder="Numer seryjny" value="<?php echo htmlspecialchars($_SESSION['formData']['nrSer'] ?? ''); ?>">
        <br>
        ...
        <select name="location" id="location">
            <option value="none" <?php echo (($_SESSION['formData']['location'] ?? '') == 'none') ? 'selected' : ''; ?>>Wybierz lokalizację</option>
        ...
        <br>
        <button type="submit" value="submit">Edytuj sprzęt</button>
    </form>
</section>
</body>
</html>
